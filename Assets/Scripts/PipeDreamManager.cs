        ...
        while (gameRunning)
        {
            ...
            for (int i = 0; i < objectGrid.Count; i++)
            {
                ...
                if (objectGrid[i].GetComponent<PipeRotator>().gameObject.tag == "Straight")
                {
                    ...
                    if (Mathf.Approximately(objectGrid[i].GetComponent<PipeRotator>().transform.rotation.eulerAngles.z, 270) || Mathf.Approximately(objectGrid[i].GetComponent<PipeRotator>().transform.rotation.eulerAngles.z, 90))
                    {
                    ...
                    else if (Mathf.Approximately(objectGrid[i].GetComponent<PipeRotator>().transform.rotation.eulerAngles.z, 180) || Mathf.Approximately(objectGrid[i].GetComponent<PipeRotator>().transform.rotation.eulerAngles.z, 0))
                    {
                ...
                else if (objectGrid[i].GetComponent<PipeRotator>().gameObject.tag == "Turn")
                {
                    ...
                    if (Mathf.Approximately(objectGrid[i].GetComponent<PipeRotator>().transform.rotation.eulerAngles.z, 270))
                    {
                    ...
                    else if (Mathf.Approximately(objectGrid[i].GetComponent<PipeRotator>().transform.rotation.eulerAngles.z, 180))
                    {
                    ...
                    else if (Mathf.Approximately(objectGrid[i].GetComponent<PipeRotator>().transform.rotation.eulerAngles.z, 90))
                    {
                    ...
                    else if (Mathf.Approximately(objectGrid[i].GetComponent<PipeRotator>().transform.rotation.eulerAngles.z, 0))
                    {
